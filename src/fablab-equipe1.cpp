...
#include "Particle.h"
#line 1 "/mnt/c/src/fablab/fablab-equipe1/src/fablab-equipe1.ino"
...
void setup();
void loop();
#line 5 "/mnt/c/src/fablab/fablab-equipe1/src/fablab-equipe1.ino"
...
MQTT client("207.253.185.55", 1883, MQTTcallback);                 // we will be using the public Eclipse MQTT server
// byte server1[] = {192,168,1,84};
// MQTT client(server1,1883,MQTTcallback);
